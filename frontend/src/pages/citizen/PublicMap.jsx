  ...
  return (
    <div className="flex flex-col h-[calc(100vh-140px)] gap-4">
      ...
      <div className="bg-white border border-gray-200 rounded-xl shadow-sm px-4 py-3 flex flex-wrap items-center gap-3 z-10">
        <h1 className="text-lg font-bold text-gray-800 mr-2">{t('public_issues_map')}</h1>
        <span className="text-xs text-gray-400">{t('issues_shown').replace('{count}', filtered.length)}</span>
